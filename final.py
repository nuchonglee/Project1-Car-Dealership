    ...
    try:
        ...
        while(1):
            ...
            if choice == 1:
                ...
                cur.execute(sql,args)
                rows = cur.fetchall()
                l = '{:>10}{:>15}{:>15}{:>10}{:>15}{:>10}{:>10}'.format('Price','brand','year','titlestatus','mileage','color')
                print(l)
                print('---------------------------------------------------------------------------')
                for row in rows:
                    l = '{:>10}{:>15}{:>15}{:>10}{:>15}{:>10}{:>10}'.format(row[0],row[1],row[2],row[3],row[4],row[5])
                    print(l)
            ...
            if choice == 2:
                while(1):
                    ...
                    if change == 1:
                        ...
                        sql = '''Update car set c_price = ? where c_custkey = ? adn c_carkey = ?'''
                    ...
                    if change == 2:
                        ...
                        sql = '''Update car set c_brand = ? where c_custkey = ? adn c_carkey = ?'''
                    ...
                    if change == 3:
                        ...
                        sql = '''Update car set c_year = ? where c_custkey = ? adn c_carkey = ?'''
                        cur.execute(sql,[new,id,carID])
                        _conn.commit()
                        print('---------------------')
                    ...
                    if change == 4:
                        ...
                        sql = '''Update car set c_titlestatus = ? where c_custkey = ? adn c_carkey = ?'''
                        cur.execute(sql,[new,id,carID])
                        _conn.commit()
                        print('---------------------')
                    ...
                    if change == 5:
                        ...
                        sql = '''Update car set c_mileage = ? where c_custkey = ? adn c_carkey = ?'''
                        cur.execute(sql,[new,id,carID])
                        _conn.commit()
                        print('---------------------')
                    ...
                    if change == 6:
                        ...
                        sql = '''Update car set c_color = ? where c_custkey = ? adn c_carkey = ?'''
                        cur.execute(sql,[new,id,carID])
                        _conn.commit()
                        print('---------------------')
            ...
            if choice == 3:
                while(1):
                    ...
                    if change == 0:
                        return update(_conn,id)
                    if change == 1:
                        sql = '''Delete from car where c_custkey = ? adn c_carkey = ?'''
